...
export default function CTAHero() {
  return (
    <section className="w-full overflow-hidden" style={{ background: gradient }}>
      ...
      <div className="hidden lg:block h-[674px]">
        <div className="max-w-[1320px] mx-auto relative h-full">
          ...
          {/* Pill */}
          <div className="absolute top-10 left-0 flex items-center gap-3 bg-white rounded-full px-3 py-2">
            <Image src={imgDot} alt="" width={9} height={9} />
            <span className="text-base text-[var(--dark)]">Accepting New Patients</span>
          </div>

          {/* Headline */}
          <div className="absolute left-0 top-[159px] leading-none text-[var(--dark)]">
            <p
          ...
          {/* Body */}
          <p className="absolute left-0 top-[350px] text-xl leading-[1.4] text-[var(--dark)] max-w-[438px]">
            We are currently accepting new patients. Schedule your appointment today and
            take the first step toward expert dermatologic care.
          </p>

          {/* CTAs */}
          <div className="absolute left-0 top-[549px] flex gap-4">
            <a
              href="tel:2165244009"
