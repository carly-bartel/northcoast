...
import { imgOffice } from "./assets";

export default function Practice() {
  return (
    <section id="practice" className="w-full bg-[var(--dark)]">
      <div className="max-w-[1320px] mx-auto px-6 flex flex-col lg:flex-row lg:items-center lg:justify-between py-16 lg:py-20 gap-12 lg:gap-0">
        {/* Left: text */}
        <div className="flex flex-col gap-10 lg:gap-20 lg:w-[576px]">
