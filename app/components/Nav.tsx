  ...
  return (
    <header className="w-full relative z-50">
      ...
      <div className="hidden md:flex w-full bg-[var(--dark)]">
        <div className="max-w-[1320px] mx-auto w-full flex items-center justify-end gap-12 px-6 lg:px-0 py-2">
      ...
      <div className="w-full">
        <nav className="max-w-[1320px] mx-auto flex items-center justify-between px-6 lg:px-0 py-4">
